param(
    [string[]]$Schemes = @('our_decart', 'our_decart_star', 'scheme2_server', 'scheme3_offline'),
...
$schemeMap = @{
    'our_decart' = @{
        ...
        ResultsDir = 'experiments\results\data_new\our_decart\neural_network_N10000_n32\q=100'
    }
    'our_decart_star' = @{
        Runner = 'experiments\our_decart_star\runner.py'
        ResultsDir = 'experiments\results\data_new\our_decart_star\neural_network_N10000_n32\q=100'
    }
    'scheme2_server' = @{
...
Write-Host 'Queued small-size neural_network q=100 runs finished.'