...
class DataQuerier(BaseDataQuerier):
    ...
    def query_with_metrics(self,
        ...
        print(f"\n [DataQuerier {self.querier_id}] Query stage timings:")
        print(f"   Access check: {metrics['check_time']*1000:.2f} ms")
        print(f"   Model encryption: {metrics['model_encrypt_time']*1000:.2f} ms")
        print(f"   Query execution: {metrics['query_time']*1000:.2f} ms")
        print(f"   Result decryption: {metrics['decrypt_time']*1000:.2f} ms")
